...
const SavedSearchListPage = () => {
  ...
  const handleClickSearch = (search: SavedSearch) => {
    ...
    navigate(`/properties?${newSearchParams}`)
  }
  ...
  return (
    <>
      <div className="flex min-h-screen w-full flex-col bg-slate-100 pt-16 lg:w-4/5 lg:pt-0">
        <div className="sticky top-0 z-10 hidden items-center justify-between bg-slate-100 p-4 pt-8 lg:flex">
          <div className="text-lg">Permintaan</div>
        ...
        <div className="flex grow">
          <div className="flex grow flex-col space-y-4 p-4 lg:pt-0">
            {isError ? (
                  ...
                  <CardBody className="p-3">
                    ...
                    <div className="flex flex-wrap gap-x-3 gap-y-1 py-2">
                      {Object.keys(item.filterSet ?? {}).map((filter, id) => {
                        const filterItem =
                          item.filterSet?.[
                            filter as keyof typeof item.filterSet
                          ]
                        return filterItem ? (
